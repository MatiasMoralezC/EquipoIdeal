	...
	private void initialize() {
		...
		btnVerEmpleados.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println(c.verEmpleados().toString()); 
			}
		});
		...
		btnAgregarEmpleado.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				c.agregarEmpleado(nuevoEmpleado);
			}
		});
		...
		btnFormarEquipo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				List<Empleado> equipo = c.formarEquipo(empleados, incompatibles, rolesRequeridos);
